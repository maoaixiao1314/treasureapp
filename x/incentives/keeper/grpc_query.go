...
import (
	...
	"github.com/treasurenet/x/incentives/types"
)
...
func (k Keeper) Incentive(
	...
	if err := treasurenet.ValidateAddress(req.Contract); err != nil {
...
func (k Keeper) GasMeter(
	...
	if err := treasurenet.ValidateAddress(req.Participant); err != nil {
		return nil, status.Errorf(
			codes.InvalidArgument,
