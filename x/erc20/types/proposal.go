...
func ValidateErc20Denom(denom string) error {
	...
	return treasurenet.ValidateAddress(denomSplit[1])
}
...
func (rtbp *RegisterERC20Proposal) ValidateBasic() error {
	if err := treasurenet.ValidateAddress(rtbp.Erc20Address); err != nil {
...
func (etrp *ToggleTokenRelayProposal) ValidateBasic() error {
	...
	// denom
	if err := treasurenet.ValidateAddress(etrp.Token); err != nil {
...
func (p *UpdateTokenPairERC20Proposal) ValidateBasic() error {
	if err := treasurenet.ValidateAddress(p.Erc20Address); err != nil {
		return sdkerrors.Wrap(err, "ERC20 address")
	}

	if err := treasurenet.ValidateAddress(p.NewErc20Address); err != nil {
