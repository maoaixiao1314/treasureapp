...
func init() {
	proto.RegisterType((*QueryPeriodRequest)(nil), "treasurenet.inflation.v1.QueryPeriodRequest")
	proto.RegisterType((*QueryPeriodResponse)(nil), "treasurenet.inflation.v1.QueryPeriodResponse")
	proto.RegisterType((*QueryEpochMintProvisionRequest)(nil), "treasurenet.inflation.v1.QueryEpochMintProvisionRequest")
	proto.RegisterType((*QueryEpochMintProvisionResponse)(nil), "treasurenet.inflation.v1.QueryEpochMintProvisionResponse")
	proto.RegisterType((*QueryParamsRequest)(nil), "treasurenet.inflation.v1.QueryParamsRequest")
	proto.RegisterType((*QueryParamsResponse)(nil), "treasurenet.inflation.v1.QueryParamsResponse")
}

func init() { proto.RegisterFile("treasurenet/inflation/v1/query.proto", fileDescriptor_91b9f1b5d47c7fd7) }
...
func (c *queryClient) Period(ctx context.Context, in *QueryPeriodRequest, opts ...grpc.CallOption) (*QueryPeriodResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/treasurenet.inflation.v1.Query/Period", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) EpochMintProvision(ctx context.Context, in *QueryEpochMintProvisionRequest, opts ...grpc.CallOption) (*QueryEpochMintProvisionResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/treasurenet.inflation.v1.Query/EpochMintProvision", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) Params(ctx context.Context, in *QueryParamsRequest, opts ...grpc.CallOption) (*QueryParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/treasurenet.inflation.v1.Query/Params", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Period_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/treasurenet.inflation.v1.Query/Period",
	}
...
func _Query_EpochMintProvision_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/treasurenet.inflation.v1.Query/EpochMintProvision",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_Params_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/treasurenet.inflation.v1.Query/Params",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "treasurenet.inflation.v1.Query",
	...
	Metadata: "treasurenet/inflation/v1/query.proto",
}
