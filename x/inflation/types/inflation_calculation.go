...
func CalculateEpochMintProvision(
	...
	// Multiply epochMintProvision with power reduction (10^18 for treasurenet) as the
	// calculation is based on `treasurenet` and the issued tokens need to be given in
	// `atreasurenet`
	epochProvision = epochProvision.Mul(treasurenet.PowerReduction.ToDec())
