...
// source: treasurenet/inflation/v1/genesis.proto
...
func init() {
	proto.RegisterType((*GenesisState)(nil), "treasurenet.inflation.v1.GenesisState")
	proto.RegisterType((*Params)(nil), "treasurenet.inflation.v1.Params")
}

func init() { proto.RegisterFile("treasurenet/inflation/v1/genesis.proto", fileDescriptor_1cb8eee530db1235) }
