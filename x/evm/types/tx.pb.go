...
// source: treasurenet/evm/v1/tx.proto
...
func init() {
	proto.RegisterType((*MsgEthereumTx)(nil), "treasurenet.evm.v1.MsgEthereumTx")
	proto.RegisterType((*LegacyTx)(nil), "treasurenet.evm.v1.LegacyTx")
	proto.RegisterType((*AccessListTx)(nil), "treasurenet.evm.v1.AccessListTx")
	proto.RegisterType((*DynamicFeeTx)(nil), "treasurenet.evm.v1.DynamicFeeTx")
	proto.RegisterType((*ExtensionOptionsEthereumTx)(nil), "treasurenet.evm.v1.ExtensionOptionsEthereumTx")
	proto.RegisterType((*MsgEthereumTxResponse)(nil), "treasurenet.evm.v1.MsgEthereumTxResponse")
}

func init() { proto.RegisterFile("treasurenet/evm/v1/tx.proto", fileDescriptor_f75ac0a12d075f21) }
...
func (c *msgClient) EthereumTx(ctx context.Context, in *MsgEthereumTx, opts ...grpc.CallOption) (*MsgEthereumTxResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/treasurenet.evm.v1.Msg/EthereumTx", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_EthereumTx_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/treasurenet.evm.v1.Msg/EthereumTx",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "treasurenet.evm.v1.Msg",
	...
	Metadata: "treasurenet/evm/v1/tx.proto",
}
