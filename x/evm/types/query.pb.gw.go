...
var (
	pattern_Query_Account_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"treasurenet", "evm", "v1", "account", "address"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_CosmosAccount_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"treasurenet", "evm", "v1", "cosmos_account", "address"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_ValidatorAccount_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"treasurenet", "evm", "v1", "validator_account", "cons_address"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_Balance_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"treasurenet", "evm", "v1", "balances", "address"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_Storage_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4, 1, 0, 4, 1, 5, 5}, []string{"treasurenet", "evm", "v1", "storage", "address", "key"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_Code_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"treasurenet", "evm", "v1", "codes", "address"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_TxLogs_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"treasurenet", "evm", "v1", "tx_logs", "hash"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_BlockLogs_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"treasurenet", "evm", "v1", "block_logs", "hash"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_BlockBloom_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"treasurenet", "evm", "v1", "block_bloom"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_Params_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"treasurenet", "evm", "v1", "params"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_StaticCall_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"treasurenet", "evm", "v1", "static_call"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_EthCall_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"treasurenet", "evm", "v1", "eth_call"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_EstimateGas_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"treasurenet", "evm", "v1", "estimate_gas"}, "", runtime.AssumeColonVerbOpt(true)))
)
