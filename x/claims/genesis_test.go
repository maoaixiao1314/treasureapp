...
import (
	...
	simapp "github.com/treasurenet/app"
...
var (
	now         = time.Now().UTC()
	acc1, _     = sdk.AccAddressFromBech32("eth1qxx0fdsmruzuar2fay88lfw6sce6emamyu2s8h4d")
	acc2, _     = sdk.AccAddressFromBech32("eth1nsrs4t7dngkdltehkm3p6n8dp22sz3mct9uhc8")
	testGenesis = types.GenesisState{
		Params: types.Params{
			AirdropStartTime:   now,
			DurationUntilDecay: types.DefaultDurationUntilDecay,
			DurationOfDecay:    types.DefaultDurationOfDecay,
			ClaimsDenom:        types.DefaultClaimsDenom, // atreasurenet
		},
...
func TestClaimInitGenesis(t *testing.T) {
	...
	coins := sdk.NewCoins(sdk.NewCoin("atreasurenet", sdk.NewInt(10400)))
