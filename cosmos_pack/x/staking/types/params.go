...
const (
	...
	DefaultTatTokens int64 = 1

	// DefaultEndBlock int64 = 1

	// DefaultHeightBlock int64 = 12
)
...
func NewParams(unbondingTime time.Duration, maxValidators, maxEntries, historicalEntries uint32, bondDenom string, tatTokens int64) Params {
	return Params{
...
func (p *Params) ParamSetPairs() paramtypes.ParamSetPairs {
	return paramtypes.ParamSetPairs{
		...
		paramtypes.NewParamSetPair(KeyTatTokens, &p.TatTokens, validateTatTokens),
...
// 	if v == 0 {
// 		return fmt.Errorf("height block must be positive: %d", v)
// 	}
