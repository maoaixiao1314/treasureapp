...
func (k Keeper) TatTokens(ctx sdk.Context) (res int64) {
	k.paramstore.Get(ctx, types.KeyTatTokens, &res)
	return
}

// func (k Keeper) EndBlock(ctx sdk.Context) (res int64) {
// 	k.paramstore.Get(ctx, types.KeyEndBlock, &res)
// 	return
// }
// func (k Keeper) HeightBlock(ctx sdk.Context) (res int64) {
// 	k.paramstore.Get(ctx, types.KeyHeightBlock, &res)
// 	return
// }
