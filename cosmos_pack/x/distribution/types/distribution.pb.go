...
type Params struct {
	...
	TatReward           github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,5,opt,name=tat_reward,json=tatReward,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"tat_reward" yaml:"tat_reward"`
...
// FeePool is the global fee pool for distribution. FeePool 是用于分发的全球费用池。  社区税以及通过MsgFundCommunityPool消息捐赠的链上资产由结构体 FeePool的 CommunityPool字段记录
type FeePool struct {
