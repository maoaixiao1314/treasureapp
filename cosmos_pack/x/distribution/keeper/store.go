...
// get the global fee pool distribution info 获取全球费用池分发信息
...
// GetPreviousProposerConsAddr returns the proposer consensus address for the 返回当前块的提案人一致同意地址
// current block.
...
// get the starting info associated with a delegator 获取与委托人关联的起始信息
