...
// source: treasurenet/types/web3.proto
...
func init() {
	proto.RegisterType((*ExtensionOptionsWeb3Tx)(nil), "treasurenet.types.v1.ExtensionOptionsWeb3Tx")
}

func init() { proto.RegisterFile("treasurenet/types/web3.proto", fileDescriptor_ca05fcaf1424711f) }
