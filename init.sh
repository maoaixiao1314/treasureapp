...
ethermintd start --pruning=nothing $TRACE --log_level $LOGLEVEL --minimum-gas-prices=0.0001aphoton --json-rpc.ws-address localhost:8546 --json-rpc.api eth,txpool,personal,net,debug,web3,miner
