...
// source: treasurenet/crypto/v1/ethsecp256k1/keys.proto
...
func init() {
	proto.RegisterType((*PubKey)(nil), "treasurenet.crypto.v1.ethsecp256k1.PubKey")
	proto.RegisterType((*PrivKey)(nil), "treasurenet.crypto.v1.ethsecp256k1.PrivKey")
}

func init() {
	proto.RegisterFile("treasurenet/crypto/v1/ethsecp256k1/keys.proto", fileDescriptor_0c10cadcf35beb64)
}
