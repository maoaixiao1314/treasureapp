<template lang="pug">
  div
    ...
    .h2 Getting Started
    .p__alt Read all about Treasurenet or dive straight into the code with guides.
    .features
      ...
      router-link(to="/guides").features__item.features__item__dark
        ...
        .features__item__text
          ...
          .features__item__text__p Follow guides to using popular Ethereum tools with Treasurenet.
    .sections__wrapper
      .h2 Explore Treasurenet
      .p__alt Get familiar with Treasurenet and explore its main concepts.
      .sections
    ...
    .p__alt Check out the docs for the various parts of the Treasurenet stack.
    .stack
