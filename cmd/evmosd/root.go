...
import (
	...
	treasurenetserver "github.com/treasurenet/server"
	...
	treasurenetkr "github.com/treasurenet/crypto/keyring"
)

const (
	EnvPrefix = "Treasurenet"
)

// NewRootCmd creates a new root command for treasurenetd. It is called once in the
// main function.
func NewRootCmd() (*cobra.Command, params.EncodingConfig) {
	...
	initClientCtx := client.Context{}.
		...
		WithKeyringOptions(treasurenetkr.Option()).
		WithViper(EnvPrefix)
	...
	treasurenetserver.AddCommands(rootCmd, app.DefaultNodeHome, a.newApp, a.appExport, addModuleInitFlags)
...
func (a appCreator) newApp(logger log.Logger, db dbm.DB, traceStore io.Writer, appOpts servertypes.AppOptions) servertypes.Application {
	...
	treasurenetApp := app.NewTreasurenet(
...
func (a appCreator) appExport(
	...
	var treasurenetApp *app.Treasurenet
	...
	if height != -1 {
		treasurenetApp = app.NewTreasurenet(logger, db, traceStore, false, map[int64]bool{}, "", uint(1), a.encCfg, appOpts)

		if err := treasurenetApp.LoadHeight(height); err != nil {
			return servertypes.ExportedApp{}, err
		}
	} else {
		treasurenetApp = app.NewTreasurenet(logger, db, traceStore, true, map[int64]bool{}, "", uint(1), a.encCfg, appOpts)
	}
